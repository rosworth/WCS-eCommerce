...
namespace WCS_eCommerce.App_Code {
    ...
    public partial class dsOrder : global::System.Data.DataSet {
        ...
        public partial class orderDataTable : global::System.Data.TypedTableBase<orderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public orderRow AddorderRow(System.DateTime dateTime, double deposit, double total, string customerID, string payment, string status) {
        ...
        public partial class orderRow : global::System.Data.DataRow {
            ...
            public double deposit {
                get {
                    try {
                        return ((double)(this[this.tableorder.depositColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'deposit\' in table \'order\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableorder.depositColumn] = value;
                }
            }
            ...
            public bool IsdepositNull() {
                return this.IsNull(this.tableorder.depositColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetdepositNull() {
                this[this.tableorder.depositColumn] = global::System.Convert.DBNull;
            }
...
namespace WCS_eCommerce.App_Code.dsOrderTableAdapters {
    ...
    public partial class orderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `order` (`dateTime`, `deposit`, `total`, `customerID`, `payment`, `st" +
                "atus`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("deposit", global::System.Data.OleDb.OleDbType.Double, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "deposit", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `order` SET `dateTime` = ?, `deposit` = ?, `total` = ?, `customerID` = ?, " +
                "`payment` = ?, `status` = ? WHERE ((`orderID` = ?))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("deposit", global::System.Data.OleDb.OleDbType.Double, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "deposit", global::System.Data.DataRowVersion.Current, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["WCSConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT orderID, [dateTime], deposit, total, customerID, payment, status FROM [ord" +
                "er]";
        ...
        public virtual int Fill(dsOrder.orderDataTable dataTable) {
        ...
        public virtual dsOrder.orderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsOrder.orderDataTable dataTable = new dsOrder.orderDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsOrder.orderDataTable dataTable) {
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> dateTime, global::System.Nullable<double> deposit, global::System.Nullable<double> total, string customerID, string payment, string status) {
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> dateTime, global::System.Nullable<double> deposit, global::System.Nullable<double> total, string customerID, string payment, string status, int Original_orderID) {
            if ((dateTime.HasValue == true)) {
            ...
            if ((deposit.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(deposit.Value));
            }
            else {
